{{-- 
    ...
    <br>
    <a href="{{ route('adminsa.destination.attraction.create', ['destination' => $destination->id]) }}">Create New Attraction</a>
...
@section('main')
    ...
    <a href="{{ route('adminsa.destination.attraction.create', ['destination' => $destination->id]) }}">Create New Attraction</a>
        ...
        <a href="{{ route('adminsa.destination.attraction.show', ['destination' => $destination->id, 'attraction' => $attraction->id]) }}">Show</a>
                                    ...
                                    {{-- <a href="{{ route('adminsa.destination.show', $attraction->id) }}" class="btn btn-primary btn-sm">Show Attractions</a> --}}
                                </div>
                            </div>
                        </div>
                    @empty
